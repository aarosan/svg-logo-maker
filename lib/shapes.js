...
//run a switch/case to check if the input from inquirer === shape, if so, then have that be the shape and return the svg code to the createLogo() function
...
export const createLogo = (data) => {
    ...
    const combineSvg = `<svg version="1.1"
    xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink"
    width="300" height="200"> ${shapeSvg} </svg>`
